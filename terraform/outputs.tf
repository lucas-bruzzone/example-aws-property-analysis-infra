...
output "property_analysis_table_name" {
  description = "Nome da tabela DynamoDB property-analysis"
  value       = aws_dynamodb_table.property_analysis.name
}

output "property_analysis_table_arn" {
  description = "ARN da tabela DynamoDB property-analysis"
  value       = aws_dynamodb_table.property_analysis.arn
}

output "property_analysis_table_stream_arn" {
  description = "ARN do stream da tabela property-analysis"
  value       = aws_dynamodb_table.property_analysis.stream_arn
}
...
output "infrastructure_summary" {
  ...
  value = {
    ...
    dynamodb_table  = aws_dynamodb_table.property_analysis.name
