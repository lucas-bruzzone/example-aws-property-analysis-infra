...
# ===================================
# IAM ROLE - FUTURE LAMBDA ANALYSIS
# ===================================
...
# ===================================
# IAM POLICY - LAMBDA ANALYSIS PERMISSIONS
# ===================================
    ...
    Statement = [
      {
        ...
        Resource = [
          aws_dynamodb_table.property_analysis.arn,
          "${aws_dynamodb_table.property_analysis.arn}/index/*"
        ]
      },
      {
        Effect = "Allow"
